...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::.top17.fra19.lab22 {
        array set save {-anchor 1 -borderwidth 1 -justify 1 -text 1 -width 1}
    }
    namespace eval ::widgets::.top17.fra19.ent23 {
        array set save {-borderwidth 1 -textvariable 1}
    }
    namespace eval ::widgets::.top17.fra19.but24 {
    ...
    namespace eval ::widgets::.top17.fra33 {
        array set save {-borderwidth 1 -height 1 -width 1}
    }
    namespace eval ::widgets::.top17.fra33.but19 {
        array set save {-command 1 -padx 1 -pady 1 -relief 1 -text 1}
    }
    namespace eval ::widgets::.top17.lab21 {
        array set save {-anchor 1 -borderwidth 1 -font 1 -text 1 -textvariable 1}
    }
    namespace eval ::widgets::.top17.fra22 {
        array set save {-borderwidth 1 -height 1 -relief 1 -width 1}
    }
    namespace eval ::widgets::.top17.fra22.lab24 {
...
proc {_newLeeDatosIn} {ifname ofname} {
global GVar
...
set GVar(Wget,StatBar) .top17.fra22.lab24

set GVar(Msg) "Iniciando vTcl-FASTA!!!"
}
...
proc vTclWindow.top17 {base {container 0}} {
    ...
    global widget
    vTcl:DefineAlias "$base.fra22" "Frame12" vTcl:WidgetProc "$base" 1
    vTcl:DefineAlias "$base.fra22.lab24" "Label16" vTcl:WidgetProc "$base" 1
    vTcl:DefineAlias "$base.lab21" "Label15" vTcl:WidgetProc "$base" 1
    ...
    wm focusmodel $base passive
    wm geometry $base 488x148+121+104; update
    wm maxsize $base 1028 748
    wm minsize $base 132 2
    wm overrideredirect $base 0
    wm resizable $base 0 0
    wm deiconify $base
    wm title $base "vTcl-FASTA (FPR 2015)"
    vTcl:FireEvent $base <<Create>>
    }
    frame $base.fra19 \
  ...
  set GVar(file4) $GVar(FileName)
    ...
    frame $base.fra33 \
        -borderwidth 2 -height 75 -width 125 
    button $base.fra33.but19 \
        -command {_newLeeDatosIn $GVar(file1) $GVar(file4)} -padx 9 -pady 3 \
        -relief groove -text Procesar... 
    label $base.lab21 \
        -anchor w -borderwidth 1 -font {{MS Sans Serif} 12 bold} \
        -text {Iniciando vTcl-FASTA!!!} -textvariable GVar(Msg) 
    frame $base.fra22 \
    ...
    pack $base.fra19.lab22 \
        -in $base.fra19 -anchor center -expand 0 -fill none -side left 
    pack $base.fra19.ent23 \
        -in $base.fra19 -anchor center -expand 1 -fill x -side left 
    pack $base.fra19.but24 \
        -in $base.fra19 -anchor center -expand 0 -fill none -padx 5 \
        -side right 
    pack $base.fra29 \
        -in $base -anchor center -expand 0 -fill x -side top 
    ...
    pack $base.fra33.but19 \
        -in $base.fra33 -anchor center -expand 1 -fill both -side left 
    pack $base.lab21 \
        -in $base -anchor center -expand 0 -fill x -padx 3 -pady 3 -side top 
    pack $base.fra22 \
        -in $base -anchor center -expand 0 -fill x -side top 
    place $base.fra22.lab24 \
        -in $base.fra22 -x 0 -y 0 -relheight 1 -anchor nw -bordermode ignore 
